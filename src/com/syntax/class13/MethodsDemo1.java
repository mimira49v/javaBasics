...
public class MethodsDemo1 {
    ...
    // int number this is a parametar that we ca pass to this method when called
    ...
    // create a method to check a name if name is Teyfur it prints send memes
    // otherwise if name is Name is Maha prints i am a doctor
    ...
    public static void main(String[] args){
       ...
       MethodsDemo1 object1=new MethodsDemo1(); // creating an object
